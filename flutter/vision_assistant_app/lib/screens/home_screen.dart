...
import '../services/ml_kit_detection_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  /// Chosen at compile-time via [useGoogleMlKit] in main.dart.
  final BaseDetectionService _detectionService =
      useGoogleMlKit ? MLKitDetectionService() : DetectionService();
